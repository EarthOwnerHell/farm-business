...
const SECRET_KEY = 'eyJ2ZXJzaW9uIjoiUDJQIiwiZGF0YSI6eyJwYXlpbl9tZXJjaGFudF9zaXRlX3VpZCI6IjZzeDVwOC0wMCIsInVzZXJfaWQiOiIzNzUyOTgxODg1MDciLCJzZWNyZXQiOiI3MmRmZmYwZTNlN2NlYWVkOTk1NmEwYzljMDc5ODcyYjliZGJmYTVjMjE1ZjA2ZjBjYTI1MGRhNGM2MzNjYTExIn19';
...
❗Для отмена покупки напишите любое слово`);
      ...
      ❗ Отмена.`);
          ...
          await qiwiApi.getBillInfo(billId).then(data => {
           ...
           console.log(data.amount.value, typeof data.amount.value)
           msg.send(`✅✅✅ Успешная покупка привилегии <<${forText[data.amount.value]}>> !\n💫 Забирать бонусы можно через кнопку <<Профиль>>`)
           vkMsg(479647111, `https://vk.com/id${msg.senderId} купил привилегию`)
